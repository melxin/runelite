...
public final class WorldMapRenderer {
	...
	@ObfuscatedSignature(
		descriptor = "([Lxc;Ljava/util/HashMap;Lpe;Lpe;)V"
	)
	...
	@ObfuscatedName("ab")
	@ObfuscatedSignature(
		descriptor = "(Lpe;Ljava/lang/String;ZB)V",
		garbageValue = "52"
	)
	public void method6660(AbstractArchive var1, String var2, boolean var3) {
		if (!this.field3363) {
			this.loaded = false;
			this.field3363 = true;
			System.nanoTime();
			int var4 = var1.getGroupId(WorldMapCacheName.field3505.name);
			int var5 = var1.getFileId(var4, var2);
			Buffer var6 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field3505.name, var2));
			Buffer var7 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field3501.name, var2));
			System.nanoTime();
			System.nanoTime();
			this.mapAreaData = new WorldMapAreaData();

			try {
				this.mapAreaData.method6928(var6, var7, var5, var3);
			...
			Iterator var10 = this.mapAreaData.field3512.iterator();
			...
			while (var10.hasNext()) {
				...
				this.regions[var14][var15] = new WorldMapRegion(var12, var13, this.mapAreaData.method6532(), this.fonts);
			...
			for (int var17 = 0; var17 < var16; ++var17) {
				for (int var18 = 0; var18 < var9; ++var18) {
					if (this.regions[var17][var18] == null) {
						this.regions[var17][var18] = new WorldMapRegion(this.mapAreaData.getRegionLowX() + var17, this.mapAreaData.getRegionLowY() + var18, this.mapAreaData.method6532(), this.fonts);
						this.regions[var17][var18].initWorldMapData1(this.mapAreaData.field3510, this.mapAreaData.iconList);
					}
				}
			}
			...
			System.nanoTime();
			System.nanoTime();
			if (var1.isValidFileName(WorldMapCacheName.field3502.name, var2)) {
				byte[] var20 = var1.takeFileByNames(WorldMapCacheName.field3502.name, var2);
				this.compositeTextureSprite = EnumComposition.readSpritePixelsFromBytes(var20);
			}
	...
	public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		Rasterizer3D.method5057(var9, var10, var11, var12);
		...
		for (int var22 = var14.x; var22 < var14.x + var14.width; ++var22) {
			for (int var23 = var14.y; var23 < var14.height + var14.y; ++var23) {
				this.regions[var22][var23].method6535(var5 + var19 * (this.regions[var22][var23].regionX * 64 - var20) / 64, var8 - var19 * (this.regions[var22][var23].regionY * 64 - var21 + 64) / 64, var19);
			}
		}
	...
	public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
		...
		for (var19 = var14.x; var19 < var14.x + var14.width; ++var19) {
			for (var20 = var14.y; var20 < var14.height + var14.y; ++var20) {
				...
				this.regions[var19][var20].method6623(var5 + var16 * (this.regions[var19][var20].regionX * 64 - var17) / 64, var8 - var16 * (this.regions[var19][var20].regionY * 64 - var18 + 64) / 64, var16, var9);
			}
		}
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-300609178"
	)
	public List method6688(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		...
		if (!this.loaded) {
			...
			for (int var17 = var12.x; var17 < var12.x + var12.width; ++var17) {
				for (int var18 = var12.y; var18 < var12.height + var12.y; ++var18) {
					List var19 = this.regions[var17][var18].method6564(var5 + var14 * (this.regions[var17][var18].regionX * 64 - var15) / 64, var8 + var6 - var14 * (this.regions[var17][var18].regionY * 64 - var16 + 64) / 64, var14, var9, var10);
					if (!var19.isEmpty()) {
						var11.addAll(var19);
					}
				}
	...
	@ObfuscatedSignature(
		descriptor = "(I)I",
		garbageValue = "1068971551"
	)
	public int method6668() {
		return this.mapAreaData.method6497();
	}
	...
	@ObfuscatedSignature(
		...
		garbageValue = "2125844396"
	)
	public static float method6669(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, float var8, float var9, float var10) {
		...
		return var14 * var10 + var8 * var12 + var13 * var9;
	}
	...
	static final void method6699(int var0, int var1, int var2) {
		if (Huffman.cameraX < var0) {
			Huffman.cameraX = (var0 - Huffman.cameraX) * ClientPacket.field3651 / 1000 + Huffman.cameraX + ObjectSound.field983;
			if (Huffman.cameraX > var0) {
				Huffman.cameraX = var0;
			}
		}

		if (Huffman.cameraX > var0) {
			Huffman.cameraX -= (Huffman.cameraX - var0) * ClientPacket.field3651 / 1000 + ObjectSound.field983;
			if (Huffman.cameraX < var0) {
				Huffman.cameraX = var0;
			}
		}

		if (class514.cameraY < var1) {
			class514.cameraY = (var1 - class514.cameraY) * ClientPacket.field3651 / 1000 + class514.cameraY + ObjectSound.field983;
			if (class514.cameraY > var1) {
				class514.cameraY = var1;
			}
		}

		if (class514.cameraY > var1) {
			class514.cameraY -= (class514.cameraY - var1) * ClientPacket.field3651 / 1000 + ObjectSound.field983;
			if (class514.cameraY < var1) {
				class514.cameraY = var1;
			}
		}

		if (ChatChannel.cameraZ < var2) {
			ChatChannel.cameraZ = (var2 - ChatChannel.cameraZ) * ClientPacket.field3651 / 1000 + ChatChannel.cameraZ + ObjectSound.field983;
			if (ChatChannel.cameraZ > var2) {
				ChatChannel.cameraZ = var2;
			}
		}

		if (ChatChannel.cameraZ > var2) {
			ChatChannel.cameraZ -= (ChatChannel.cameraZ - var2) * ClientPacket.field3651 / 1000 + ObjectSound.field983;
			if (ChatChannel.cameraZ < var2) {
				ChatChannel.cameraZ = var2;
			}
		}
