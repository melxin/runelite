...
public final class Client extends GameEngine implements Usernamed, OAuthApi, class336 {
	...
	static {
		...
		overheadTextCount = 0;
		field607 = 50;
		overheadTextXs = new int[field607];
		overheadTextYs = new int[field607];
		overheadTextAscents = new int[field607];
		overheadTextXOffsets = new int[field607];
		overheadTextColors = new int[field607];
		overheadTextEffects = new int[field607];
		field540 = new int[field607][];
		overheadTextCyclesRemaining = new int[field607];
		overheadText = new String[field607];
		viewportDrawCount = 0;
		viewportTempX = -1;
		viewportTempX = -1;
		mouseCrossX = 0;
		...
		field703 = new int[]{768, 1024, 1280, 512, 1536, 256, 0, 1792};
		...
		defaultRotations = new int[]{16776960, 16711680, 65280, 65535, 16711935, 16777215};
		publicChatMode = 0;
		tradeChatMode = 0;
		field736 = "";
	...
	void requestRefreshAccessToken(String var1) throws IOException {
		...
		URL var3 = new URL(class176.field1864 + "shield/oauth/token" + (new HttpQueryParams(var2)).encode());
		...
		var4.header("Host", (new URL(class176.field1864)).getHost());
	...
	void requestOtlToken(String var1) throws IOException {
		URL var2 = new URL(class176.field1864 + "public/v1/games/YCfdbvr2pM1zUYMxJRexZY/play");
	...
	void authenticate(String var1, String var2) throws IOException, JSONException {
		URL var3 = new URL(class316.authServiceBaseUrl + "game-session/v1/tokens");
		...
		try {
					...
					if (field676.method9855()) {
						if (this.containsAccessAndRefreshToken()) {
							try {
								...
								class28.method434(LoginState.TOKEN_RESPONSE);
							...
							try {
								...
								class28.method434(LoginState.REFRESHING_TOKEN);
						...
						class28.method434(LoginState.INIT_MOUSEHANDLER_SOCKET);
					}
				}
			}
			...
			if (class134.loginState == LoginState.INIT_MOUSEHANDLER_SOCKET) {
				...
				if (class243.field2538.status == 1) {
					...
					class243.field2538 = null;
					class28.method434(LoginState.UNMAPPED_20);
				}
			}
			...
			if (class134.loginState == LoginState.UNMAPPED_20) {
				...
				packetWriter.flush();
				var2.offset = 0;
				class28.method434(LoginState.READ_LOGIN_STATUS);
			}
			...
			if (LoginState.READ_LOGIN_STATUS == class134.loginState) {
				...
				if (((AbstractSocket)var1).isAvailable(1)) {
					...
					var2.offset = 0;
					class28.method434(LoginState.READ_RANDOM_VERIFICATION_NUMBER);
				}
			}
			...
			if (LoginState.READ_RANDOM_VERIFICATION_NUMBER == class134.loginState) {
				...
				if (var2.offset == 8) {
					...
					class28.method434(LoginState.WRITE_INITIAL_LOGIN_PACKET);
				}
			}
			...
			if (LoginState.WRITE_INITIAL_LOGIN_PACKET == class134.loginState) {
				...
				SoundSystem.method873(var32.packetBuffer);
				...
				if (class4.field9) {
					...
					var32.packetBuffer.writeIntIME(class239.field2524.hash);
					var32.packetBuffer.writeIntLE(ChatChannel.archive13.hash);
					var32.packetBuffer.writeIntLE(class7.archive8.hash);
					var32.packetBuffer.writeIntLE(WorldMapSection1.archive10.hash);
					var32.packetBuffer.writeIntME(class424.field4703.hash);
					var32.packetBuffer.writeIntME(Tile.field2872.hash);
				} else {
					var32.packetBuffer.writeInt(class239.field2524.hash);
					var32.packetBuffer.writeIntME(ChatChannel.archive13.hash);
					var32.packetBuffer.writeIntME(class157.archive9.hash);
					var32.packetBuffer.writeIntIME(class498.field5069.hash);
					var32.packetBuffer.writeInt(class424.field4703.hash);
					var32.packetBuffer.writeIntIME(PlayerComposition.field3785.hash);
					var32.packetBuffer.writeIntIME(LoginPacket.field1684.hash);
					var32.packetBuffer.writeIntME(0);
					var32.packetBuffer.writeInt(ApproximateRouteStrategy.archive2.hash);
					var32.packetBuffer.writeIntLE(WorldEntity.archive12.hash);
					...
					var32.packetBuffer.writeIntME(JagNetThread.field4545.hash);
					var32.packetBuffer.writeIntME(LoginScreenAnimation.archive4.hash);
					var32.packetBuffer.writeIntLE(LoginState.field497.hash);
					var32.packetBuffer.writeIntIME(class195.field2052.hash);
					var32.packetBuffer.writeIntIME(WorldMapSection1.archive10.hash);
					var32.packetBuffer.writeIntME(class7.archive8.hash);
				}
				...
				class28.method434(LoginState.READ_CLIENT_INFO_STATUS);
			}
			...
			if (class134.loginState == LoginState.READ_CLIENT_INFO_STATUS && ((AbstractSocket)var1).available() > 0) {
				...
				if (var12 == 21 && gameState == 20) {
					class28.method434(LoginState.READ_PROFILE_TRANSFER_TIME);
				} else if (var12 == 2) {
					if (class4.field9) {
						class28.method434(LoginState.UNMAPPED_21);
					} else {
						class28.method434(LoginState.UNMAPPED);
					}
				} else if (var12 == 15 && gameState == 40) {
					packetWriter.serverPacketLength = -1;
					class28.method434(LoginState.UNMAPPED_19);
				} else if (var12 == 64) {
					class28.method434(LoginState.READ_STATE_11_PACKET_SIZE);
				} else if (var12 == 23 && field560 < 1) {
					++field560;
					class28.method434(LoginState.SHUTDOWN_PREVIOUS_CONNECTION);
				} else if (var12 == 29) {
					class28.method434(LoginState.UNMAPPED_17);
				} else {
					if (var12 != 69) {
						TaskHandler.getLoginError(var12);
						return;
					...
					class28.method434(LoginState.READ_DIGEST_PARSER_PACKET_SIZE);
				}
			}
			...
			if (LoginState.READ_DIGEST_PARSER_PACKET_SIZE == class134.loginState && ((AbstractSocket)var1).available() >= 2) {
				...
				class28.method434(LoginState.SUBMIT_DIGEST_PARSER_TASK);
			}
			...
			if (class134.loginState == LoginState.SUBMIT_DIGEST_PARSER_TASK && ((AbstractSocket)var1).available() >= SpotAnimationDefinition.field2084) {
				...
				try {
					...
					case 0:
						...
						class28.method434(LoginState.WRITE_DIGEST_PARSER_RESULT);
						break;
					default:
			...
			if (class134.loginState == LoginState.READ_STATE_11_PACKET_SIZE && ((AbstractSocket)var1).available() > 0) {
				...
				class28.method434(LoginState.UNMAPPED_11);
			}
			...
			if (class134.loginState == LoginState.READ_PROFILE_TRANSFER_TIME && ((AbstractSocket)var1).available() > 0) {
				...
				class28.method434(LoginState.PROFILE_TRANSFER);
			}
			...
			if (class134.loginState == LoginState.PROFILE_TRANSFER) {
				...
				if (LoginState.UNMAPPED == class134.loginState && ((AbstractSocket)var1).available() >= 1) {
					...
					class28.method434(LoginState.READ_ACCOUNT_INFO);
				}
				...
				if (LoginState.READ_ACCOUNT_INFO == class134.loginState && ((AbstractSocket)var1).available() >= ModeWhere.field4640) {
					...
					class28.method434(LoginState.SET_SERVER_PROTOCOL);
				}
				...
				if (LoginState.SET_SERVER_PROTOCOL == class134.loginState && ((AbstractSocket)var1).available() >= packetWriter.serverPacketLength) {
					...
					class28.method434(LoginState.UPDATE_PLAYER_AND_LOAD_REGIONS);
				}
				...
				if (class134.loginState == LoginState.UPDATE_PLAYER_AND_LOAD_REGIONS) {
					...
					if (class134.loginState == LoginState.UNMAPPED_17 && ((AbstractSocket)var1).available() >= 2) {
						...
						class28.method434(LoginState.UNMAPPED_18);
					}
			...
			if (gameState == 30) {
				while (true) {
					...
					if (!var40) {
						...
						int var19;
						if (timer.field4859) {
							var18 = class170.getPacketBufferNode(ClientPacket.field3320, packetWriter.isaacCipher);
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !World.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
							...
							var5 = (int)var20;
							PacketBufferNode var22 = class170.getPacketBufferNode(ClientPacket.field3296, packetWriter.isaacCipher);
						...
						if (indexCheck.field2450 > 0) {
							var18 = class170.getPacketBufferNode(ClientPacket.field3279, packetWriter.isaacCipher);
						...
						if (field604 && field650 <= 0) {
							field650 = 20;
							field604 = false;
							var18 = class170.getPacketBufferNode(ClientPacket.field3364, packetWriter.isaacCipher);
							var18.packetBuffer.writeShortAdd(camAngleY);
							var18.packetBuffer.writeShortAddLE(camAngleX);
							packetWriter.addNode(var18);
						}

						if (class498.hasFocus && !hadFocus) {
							hadFocus = true;
							var18 = class170.getPacketBufferNode(ClientPacket.field3353, packetWriter.isaacCipher);
															...
															while (true) {
																...
																if (var51 == null) {
																	...
																	for (var7 = 0; var7 < class511.topLevelWorldView.worldEntityCount; ++var7) {
																		...
																		if (var57 != null && var62.shouldSendWalk()) {
																			if (!var46) {
																				var11 = var62.baseX;
																				var12 = var62.baseY;
																				PacketBufferNode var13 = class170.getPacketBufferNode(ClientPacket.field3290, packetWriter.isaacCipher);
																				var13.packetBuffer.writeByte(5);
																				var13.packetBuffer.writeByteNeg(var12 + var58.baseY);
																				var13.packetBuffer.writeByte(indexCheck.isValidIndexInRange(82) ? (indexCheck.isValidIndexInRange(81) ? 2 : 1) : 0);
																				var13.packetBuffer.writeShortAdd(var11 + var58.baseX);
																	...
																	if (!var46 && class511.topLevelWorldView.scene.shouldSendWalk()) {
																		...
																		var60 = class170.getPacketBufferNode(ClientPacket.field3290, packetWriter.isaacCipher);
																		var60.packetBuffer.writeByte(5);
																		var60.packetBuffer.writeByteNeg(var8 + class511.topLevelWorldView.baseY);
																		var60.packetBuffer.writeByte(indexCheck.isValidIndexInRange(82) ? (indexCheck.isValidIndexInRange(81) ? 2 : 1) : 0);
																		var60.packetBuffer.writeShortAdd(var7 + class511.topLevelWorldView.baseX);
																	...
																	if (var7 > 15000 && var8 > 15000) {
																		...
																		var60 = class170.getPacketBufferNode(ClientPacket.field3311, packetWriter.isaacCipher);
																		packetWriter.addNode(var60);
																	}
																	...
																	if (packetWriter.pendingWrites > 50) {
																		var60 = class170.getPacketBufferNode(ClientPacket.field3367, packetWriter.isaacCipher);
																		packetWriter.addNode(var60);
																	}
																			...
																			case 1:
																				...
																				if (var45) {
																					...
																					if (var34 != null) {
																						...
																						var35.packetBuffer.writeIntME(var51.field2444.id);
																						var35.packetBuffer.writeByteNeg(var51.field2444.childIndex);
																						var35.packetBuffer.writeIntLE(var34[1]);
																						var35.packetBuffer.writeIntLE(var51.field2444.method6882());
																						var35.packetBuffer.writeIntME(var34[0]);
																						var35.packetBuffer.writeIntME(var34[2]);
					...
					var41 = class170.getPacketBufferNode(ClientPacket.field3341, packetWriter.isaacCipher);
					var41.packetBuffer.writeByte(0);
					var3 = var41.packetBuffer.offset;
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3533 == var1.serverPacket) {
					LoginPacket.field1682 = var3.readUnsignedByteSub();
					field580 = var3.readUnsignedByteNeg();
					NPC.field1350 = var3.readUnsignedIntIME();
				...
				if (ServerPacket.field3411 == var1.serverPacket) {
					...
					field580 = var3.readUnsignedIntIME();
				...
				if (ServerPacket.field3516 == var1.serverPacket) {
					rebootTimer = var3.readUnsignedIntME() * 30;
					field711 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3518 == var1.serverPacket) {
					...
					var16 = var3.method9599();
					var67 = var3.readUnsignedByteSub() * 4;
					var63 = var3.readByteSub();
					var66 = var3.readUnsignedByteNeg() * 4;
					var64 = var3.method9599();
					var18 = var3.readUnsignedIntME();
				...
				if (ServerPacket.field3484 == var1.serverPacket) {
					var83 = var3.readUnsignedIntIME() == 1;
					var5 = var3.readInt();
					var22 = ModeWhere.widgetDefinition.method6519(var5);
				...
				if (ServerPacket.field3508 == var1.serverPacket) {
					...
					PacketBufferNode var57 = class170.getPacketBufferNode(ClientPacket.field3360, packetWriter.isaacCipher);
					var57.packetBuffer.writeByteSub(var6);
					var57.packetBuffer.writeIntME(var20);
					var57.packetBuffer.writeInt(var5);
					var57.packetBuffer.writeShortLE(GameEngine.fps);
				...
				if (ServerPacket.field3426 == var1.serverPacket) {
					var20 = var3.readInt();
					var5 = var3.readUnsignedShort();
					if (var20 < -70000) {
						var5 += 32768;
			...
			if (isMenuOpen) {
				...
				if (var20 != 1 && (World.mouseCam || var20 != 4)) {
					...
					if (var2 < class105.menuX - 10 || var2 > class330.menuWidth + class105.menuX + 10 || var3 < UserComparator9.menuY - 10 || var3 > IntProjection.menuHeight + UserComparator9.menuY + 10) {
						isMenuOpen = false;
						class137.method3188(class105.menuX, UserComparator9.menuY, class330.menuWidth, IntProjection.menuHeight);
					}
				}
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null && ObjectSound.method1976(clickedWidget) != null) {
						PacketBufferNode var11 = class170.getPacketBufferNode(ClientPacket.field3361, packetWriter.isaacCipher);
						var11.packetBuffer.writeByteNeg(draggedOnWidget.childIndex);
						var11.packetBuffer.writeIntIME(clickedWidget.id);
						var11.packetBuffer.writeShortAddLE(clickedWidget.childIndex);
						var11.packetBuffer.writeShortAdd(draggedOnWidget.itemId);
						var11.packetBuffer.writeInt(draggedOnWidget.id);
						var11.packetBuffer.writeByteNeg(clickedWidget.itemId);
				...
				for (int var1 = 0; var1 <= 28; ++var1) {
					...
					if (var2 != null) {
						...
						case 21:
							...
							break;
						case 22:
							class316.authServiceBaseUrl = var2;
							break;
						case 25:
