...
public final class Client extends GameEngine implements Usernamed, OAuthApi, class338 {
	...
	static {
		...
		field638 = new int[]{44, 45, 46, 47, 48, 49, 50, 51};
		...
		menuArguments1 = new int[]{16776960, 16711680, 65280, 65535, 16711935, 16777215};
		publicChatMode = 0;
		tradeChatMode = 0;
		field731 = "";
		field758 = new long[100];
	...
	void requestRefreshAccessToken(String var1) throws IOException {
		...
		URL var3 = new URL(class246.field2617 + "shield/oauth/token" + (new HttpQueryParams(var2)).encode());
		...
		var4.header("Host", (new URL(class246.field2617)).getHost());
	...
	void requestOtlToken(String var1) throws IOException {
		URL var2 = new URL(class246.field2617 + "public/v1/games/YCfdbvr2pM1zUYMxJRexZY/play");
					...
					if (class33.loginState != LoginState.UNMAPPED_19) {
						...
						if (((AbstractSocket)var1).available() >= packetWriter.serverPacketLength) {
							...
							if (packetWriter != null && packetWriter.isaacCipher != null) {
								var30 = class218.getPacketBufferNode(ClientPacket.field3333, packetWriter.isaacCipher);
		...
		if (hadNetworkError) {
			...
			if (gameState == 30) {
				...
				while (class161.method3517()) {
					var18 = class218.getPacketBufferNode(ClientPacket.field3270, packetWriter.isaacCipher);
				...
				if (timer.field4839) {
					var18 = class218.getPacketBufferNode(ClientPacket.field3273, packetWriter.isaacCipher);
					var18.packetBuffer.writeByte(0);
					var2 = var18.packetBuffer.offset;
				...
				if (MouseHandler.MouseHandler_lastButton == 1 || !class429.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
					...
					var5 = (int)var20;
					PacketBufferNode var22 = class218.getPacketBufferNode(ClientPacket.field3294, packetWriter.isaacCipher);
				...
				if (indexCheck.field2918 > 0) {
					var18 = class218.getPacketBufferNode(ClientPacket.field3355, packetWriter.isaacCipher);
				...
				if (field606 && field777 <= 0) {
					field777 = 20;
					field606 = false;
					var18 = class218.getPacketBufferNode(ClientPacket.field3345, packetWriter.isaacCipher);
				...
				if (class327.hasFocus && !hadFocus) {
					hadFocus = true;
					var18 = class218.getPacketBufferNode(ClientPacket.field3308, packetWriter.isaacCipher);
															...
															while (true) {
																...
																if (var49 == null) {
																	...
																	for (var7 = 0; var7 < ConcurrentMidiTask.topLevelWorldView.worldEntityCount; ++var7) {
																		...
																		if (var63 != null && var33.shouldSendWalk()) {
																			if (!var38) {
																				var11 = var33.baseX;
																				var12 = var33.baseY;
																				PacketBufferNode var13 = class218.getPacketBufferNode(ClientPacket.field3285, packetWriter.isaacCipher);
																	...
																	if (!var38 && ConcurrentMidiTask.topLevelWorldView.scene.shouldSendWalk()) {
																		...
																		PacketBufferNode var62 = class218.getPacketBufferNode(ClientPacket.field3285, packetWriter.isaacCipher);
																	...
																	if (var7 > 15000 && var9 > 15000) {
																		...
																		var65 = class218.getPacketBufferNode(ClientPacket.field3286, packetWriter.isaacCipher);
																	...
																	if (packetWriter.pendingWrites > 50) {
																		var65 = class218.getPacketBufferNode(ClientPacket.field3288, packetWriter.isaacCipher);
																		packetWriter.addNode(var65);
																	}
	...
	final void drawLoggedIn() {
		...
		if (!isMenuOpen) {
			if (viewportX != -1) {
				var1 = viewportX;
				int var2 = viewportY;
				if ((field650.field5518 >= 2 || isItemSelected != 0 || isSpellSelected) && showMouseOverText) {
					int var3 = field650.field5518 - 1;
					String var5;
					if (isItemSelected == 1 && field650.field5518 < 2) {
						var5 = "Use" + " " + field659 + " " + "->";
					} else if (isSpellSelected && field650.field5518 < 2) {
						var5 = selectedSpellActionName + " " + selectedSpellName + " " + "->";
					} else {
						var5 = field650.method10250(var3);
					}

					if (field650.field5518 > 2) {
						var5 = var5 + TransformationMatrix.colorStartTag(16777215) + " " + '/' + " " + (field650.field5518 - 2) + " more options";
					}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3493 == var1.serverPacket) {
					...
					field697[++menuOptionsCount - 1 & 31] = var54.field5444;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3425 == var1.serverPacket) {
					...
					if (!var64 && field586 == 0) {
						field758[crossWorldMessageIdsIndex] = var34;
				...
				if (ServerPacket.field3403 == var1.serverPacket) {
					...
					if (!var62) {
						field758[crossWorldMessageIdsIndex] = var42;
						crossWorldMessageIdsIndex = (crossWorldMessageIdsIndex + 1) % 100;
				...
				if (ServerPacket.field3387 == var1.serverPacket) {
					...
					if (!var85 && field586 == 0) {
						field758[crossWorldMessageIdsIndex] = var45;
						crossWorldMessageIdsIndex = (crossWorldMessageIdsIndex + 1) % 100;
				...
				if (ServerPacket.field3409 == var1.serverPacket) {
					...
					PacketBufferNode var74 = class218.getPacketBufferNode(ClientPacket.field3274, packetWriter.isaacCipher);
				...
				if (ServerPacket.field3439 == var1.serverPacket) {
					...
					if (!var11) {
						field758[crossWorldMessageIdsIndex] = var31;
						crossWorldMessageIdsIndex = (crossWorldMessageIdsIndex + 1) % 100;
	...
	@Export("menu")
	final void menu() {
		class266.method5348(field650);
		if (clickedWidget == null) {
			int var1 = MouseHandler.MouseHandler_lastButton;
			if (isMenuOpen) {
				if (var1 != 1 && (class429.mouseCam || var1 != 4) && !field650.method10256(MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y)) {
					isMenuOpen = false;
					field650.method10259();
				}

				if (var1 == 1 || !class429.mouseCam && var1 == 4) {
					field650.method10257(MouseHandler.MouseHandler_lastPressedX, MouseHandler.MouseHandler_lastPressedY);
					isMenuOpen = false;
					field650.method10259();
				}
			} else {
				...
				if ((var1 == 1 || !class429.mouseCam && var1 == 4) && field650.field5518 > 0) {
					field650.method10255(var2);
				}

				if (var1 == 2 && field650.field5518 > 0) {
	...
	final boolean shouldLeftClickOpenMenu() {
		...
		return (leftClickOpensMenu && field650.field5518 > 2 || WorldMapLabelSize.method5530(var1)) && !field650.field5528[var1];
	}
	...
	final void openMenu(int var1, int var2) {
		field650.method10252(var1, var2);
	...
	final void method1248() {
		...
		if (field604 && field683) {
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null && class358.method6669(clickedWidget) != null) {
						PacketBufferNode var9 = class218.getPacketBufferNode(ClientPacket.field3339, packetWriter.isaacCipher);
			...
			if (class535.widgetDragDuration > 1) {
				if (!isDraggingWidget && field650.field5518 > 0) {
