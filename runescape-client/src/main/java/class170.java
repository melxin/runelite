...
public class class170 extends class148 {
	...
	static void revalidateWidgetScroll(Widget[] var0, Widget var1, boolean var2) {
		...
		BufferedNetSocket.resizeInterface(var0, var1.field3962, var1.field3968, var1.id, var1.childIndex * -1626125685, var3, var4, var2);
		if (var1.children != null) {
			BufferedNetSocket.resizeInterface(var1.children, 0, var1.children.length - 1, var1.id, -1, var3, var4, var2);
		}
		...
		if (var1.childIndex * -1626125685 == -1) {
			...
			if (var5 != null) {
				...
				if (class232.widgetDefinition.loadInterface(var6)) {
					BufferedNetSocket.resizeInterface(class232.widgetDefinition.Widget_interfaceComponents[var6], 0, class232.widgetDefinition.Widget_interfaceComponents[var6].length - 1, -1, -1, var3, var4, var2);
				}
			}
		}
