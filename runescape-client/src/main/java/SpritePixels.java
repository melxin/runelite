...
public final class SpritePixels extends Rasterizer2D {
	...
	@ObfuscatedName("am")
	public void method10753(int var1, int var2, int var3) {
		var1 += this.xOffset;
		var2 += this.yOffset;
		int var4 = var1 + var2 * Rasterizer2D.Rasterizer2D_width;
		int var5 = 0;
		...
		if (var7 > 0 && var6 > 0) {
			if (var3 == 256) {
				method10730(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9);
			} else {
				method10755(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9, var3);
			}
	...
	@ObfuscatedName("aj")
	public void method10769(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			int var6 = this.subWidth;
			int var7 = this.subHeight;
			int var8 = 0;
			...
			if (var5 == 256) {
				method10757(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6);
			} else {
				method10743(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5);
			}
	...
	@ObfuscatedName("bw")
	public void method10758(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
	...
	@ObfuscatedName("bx")
	public void method10761(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
		try {
			int var10 = -var3 / 2;
			int var11 = -var4 / 2;
	...
	@ObfuscatedName("bd")
	public void method10770(int var1, int var2, int var3, int var4) {
		this.method10763(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4);
	}

	@ObfuscatedName("bi")
	void method10763(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) {
			var1 -= this.xOffset << 4;
			var2 -= this.yOffset << 4;
	...
	@ObfuscatedName("ap")
	static void method10730(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
	...
	@ObfuscatedName("ab")
	static void method10755(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13) {
		for (var8 = -var10; var8 < 0; ++var8) {
			for (var6 = -var9; var6 < 0; ++var6) {
				var0 = var4[var5++];
				if (var0 != 0) {
	...
	@ObfuscatedName("bu")
	static void method10757(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15) {
	...
	@ObfuscatedName("bh")
	static void method10743(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16) {
