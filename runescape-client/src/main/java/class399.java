	...
	static final void method8291(class327 var0) {
		...
		if (class327.field3660 == var0) {
			...
			if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
				var7 = Client.hintArrowType == -1 ? class32.worldView.plane : Client.hintArrowType;
			...
			if (class327.field3653 == var0) {
				...
				boolean var33 = var1.readUnsignedIntLE() == 1;
				var11 = var1.readUnsignedShortAdd();
				if (var21 >= 0 && var20 >= 0 && var21 < class32.worldView.sizeX && var20 < class32.worldView.sizeY) {
					var12 = Client.hintArrowType == -1 ? class32.worldView.plane : Client.hintArrowType;
				...
				if (var3 >= 0 && var4 >= 0 && var3 < class32.worldView.sizeX && var4 < class32.worldView.sizeY) {
					var20 = Client.hintArrowType == -1 ? class32.worldView.plane : Client.hintArrowType;
				...
				if (class327.field3657 == var0) {
					...
					var4 = var1.readUnsignedIntLE() & 31;
					...
					if (class327.field3659 == var0) {
						...
						if (var6 >= 0 && var7 >= 0 && var6 < class32.worldView.sizeX && var7 < class32.worldView.sizeY) {
							...
							var21 = Client.hintArrowType == -1 ? class32.worldView.plane : Client.hintArrowType;
						...
						if (class327.field3655 == var0) {
							...
							int var25 = var1.readUnsignedShortAddLE();
							...
							if (0 <= var4 && var4 < 104 && 0 <= var5 && var5 < 104) {
								var21 = Client.hintArrowType == -1 ? var7 : Client.hintArrowType;
							...
							if (class327.field3662 == var0) {
								...
								var5 = (var4 >> 4 & 7) + class48.field674;
								var6 = (var4 & 7) + WorldMapRenderer.field3375;
								short var29 = (short)var1.readUnsignedByteAdd();
								var21 = var1.readShort();
								var20 = var1.method11535();
								short var32 = (short)var1.readInt();
								...
								if (class327.field3652 == var0) {
									...
									if (var17 != null) {
										var18 = Client.hintArrowType == -1 ? class32.worldView.plane : Client.hintArrowType;
								...
								if (class327.field3656 == var0) {
									...
									if (0 <= var21 && var21 < 103 && 0 <= var20 && var20 < 103) {
										var10 = Client.hintArrowType == -1 ? class32.worldView.plane : Client.hintArrowType;
							...
							if (var11 >= 0 && var12 >= 0 && var11 < class32.worldView.sizeX && var12 < class32.worldView.sizeY) {
								var13 = Client.hintArrowType == -1 ? class32.worldView.plane : Client.hintArrowType;
