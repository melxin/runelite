...
public class class414 {
	...
	@ObfuscatedSignature(
		...
		garbageValue = "50331293"
	)
	static final void method8524(WorldView var0, byte[] var1, int var2, int var3) {
		...
		while (true) {
			...
			while (true) {
				...
				if (var15 > 0 && var16 > 0 && var15 < var0.tileHeights[0].length - 2 && var16 < var0.tileHeights[0][0].length - 2) {
					...
					JagNetThread.addObjects(var0, var11, var15, var16, var5, var14, var13, var18);
				}
			}
		}
	}
