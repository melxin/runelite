...
public abstract class AbstractFont extends Rasterizer2D {
			...
			for (var13 = 0; var13 < 256; ++var13) {
				if (var13 != 32 && var13 != 160) {
					for (var8 = 0; var8 < 256; ++var8) {
						if (var8 != 32 && var8 != 160) {
							this.kerning[var8 + (var13 << 8)] = (byte)method9718(var11, var12, var4, this.advances, var10, var13, var8);
						}
					}
				}
			}
	...
	public int charWidth(char var1) {
		...
		return this.advances[Sound.charToByteCp1252(var1) & 255];
	}
		...
		if (var1 == null) {
			...
			for (int var5 = 0; var5 < var1.length(); ++var5) {
				...
				if (var6 == '<') {
						...
						if (var7.equals("lt")) {
							...
							if (!var7.equals("gt")) {
								if (var7.startsWith("img=")) {
									try {
										int var8 = Message.method778(var7.substring(4));
					...
					if (var2 == -1) {
						var4 += this.advances[(char)(Sound.charToByteCp1252(var6) & 255)];
				...
				if (var15 == '<') {
					...
					if (var15 == '>' && var10 != -1) {
						...
						if (var16.equals("br")) {
							...
							try {
								int var17 = Message.method778(var16.substring(4));
	...
	@ObfuscatedName("am")
	@ObfuscatedSignature(
		descriptor = "(IILjava/lang/String;II)Lrl;"
	)
	public Bounds method9826(int var1, int var2, String var3, int var4, int var5) {
	...
	@ObfuscatedName("bs")
	@ObfuscatedSignature(
		descriptor = "(Lsi;IIIII)Lvp;"
	)
	public class569 method9809(class474 var1, int var2, int var3, int var4, int var5, int var6) {
		if (!var1.method9836()) {
			this.reset(var4, var5);
			var3 -= this.ascent;

			for (int var7 = 0; var7 < var1.method9833(); ++var7) {
				class472 var8 = var1.method9837(var7);
				if (var6 != -1 && var8.field5323 > var6) {
					return new class569(var8.field5324, var8.field5323);
				}

				char var9 = var8.field5322;
				if (var9 != '\n') {
					if (var1.method9832(var7)) {
						var9 = '*';
					}
					...
					if (var9 != '\t') {
						...
						int var10 = var2 + var8.field5324;
						int var11 = var3 + var8.field5323;
		...
		return var1.method9855();
	}

	@ObfuscatedName("bz")
	public void method9738(String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var8 = null;
			if (var7 != null) {
				var8 = this.method9743(var7, var1.length());
			}
			...
			this.method9750(var1, var2 - this.stringWidth(var1) / 2, var3, var8, (int[])null, var9);
		}
	}

	@ObfuscatedName("bk")
	public void method9739(String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var8 = null;
			if (var7 != null) {
			...
			this.method9750(var1, var2 - this.stringWidth(var1) / 2, var3, var8, var9, var10);
		}
	}

	@ObfuscatedName("bb")
	public void method9740(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int[] var8) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var9 = null;
			if (var8 != null) {
				var9 = this.method9743(var8, var1.length());
			}
			...
			this.method9750(var1, var2 - this.stringWidth(var1) / 2, var3, var9, (int[])null, var12);
		}
	}

	@ObfuscatedName("bj")
	public void method9741(String var1, int var2, int var3, int var4, int var5, int[] var6) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var7 = null;
			if (var6 != null) {
				var7 = this.method9743(var6, var1.length());
			}

			this.method9750(var1, var2 - this.stringWidth(var1) / 2, var3, var7, (int[])null, (int[])null);
		}
	}

	@ObfuscatedName("bm")
	public void method9742(String var1, int var2, int var3, int var4, int var5, int[] var6) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var7 = null;
			if (var6 != null) {
			...
			this.method9750(var1, var2, var3, var7, (int[])null, (int[])null);
		}
	}

	@ObfuscatedName("bp")
	int[] method9743(int[] var1, int var2) {
		if (var2 == 0) {
			return null;
		} else {
	...
	public void drawRandomAlphaAndSpacing(String var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null) {
			...
			this.method9750(var1, var2, var3, (int[])null, var7, (int[])null);
		}
	}

	@ObfuscatedName("bu")
	public void method9793(int var1, int var2, int var3, int var4) {
		var3 -= this.ascent;
		int var5 = var1 & 255;
		if (var5 != 32) {
	...
	void decodeTag(String var1) {
		try {
			if (var1.startsWith("col=")) {
				AbstractFont_color = Varcs.method3020(var1.substring(4), 16);
			} else if (var1.equals("/col")) {
				AbstractFont_color = AbstractFont_previousColor;
			} else if (var1.startsWith("str=")) {
				AbstractFont_strike = Varcs.method3020(var1.substring(4), 16);
			} else if (var1.equals("str")) {
				AbstractFont_strike = 8388608;
			} else if (var1.equals("/str")) {
				AbstractFont_strike = -1;
			} else if (var1.startsWith("u=")) {
				AbstractFont_underline = Varcs.method3020(var1.substring(2), 16);
			} else if (var1.equals("u")) {
				AbstractFont_underline = 0;
			} else if (var1.equals("/u")) {
				AbstractFont_underline = -1;
			} else if (var1.startsWith("shad=")) {
				AbstractFont_shadow = Varcs.method3020(var1.substring(5), 16);
	...
	void draw0(String var1, int var2, int var3) {
		...
		for (int var6 = 0; var6 < var1.length(); ++var6) {
			if (var1.charAt(var6) != 0) {
				char var7 = (char)(Sound.charToByteCp1252(var1.charAt(var6)) & 255);
				if (var7 == '<') {
					var4 = var6;
				} else {
					int var9;
						...
						if (var8.equals("lt")) {
							...
							if (!var8.equals("gt")) {
								if (var8.startsWith("img=")) {
									try {
										var9 = Message.method778(var8.substring(4));
	...
	@ObfuscatedName("bf")
	void method9750(String var1, int var2, int var3, int[] var4, int[] var5, int[] var6) {
		var3 -= this.ascent;
		int var7 = -1;
		int var8 = -1;
		int var9 = 0;
		...
		for (int var10 = 0; var10 < var1.length(); ++var10) {
			if (var1.charAt(var10) != 0) {
				char var11 = (char)(Sound.charToByteCp1252(var1.charAt(var10)) & 255);
				if (var11 == '<') {
					var7 = var10;
				} else {
					int var13;
							...
							if (!var12.equals("gt")) {
								if (var12.startsWith("img=")) {
									try {
										...
										++var9;
										var15 = Message.method778(var12.substring(4));
	...
	@ObfuscatedName("au")
	static int method9718(byte[][] var0, byte[][] var1, int[] var2, int[] var3, int[] var4, int var5, int var6) {
		int var7 = var2[var5];
