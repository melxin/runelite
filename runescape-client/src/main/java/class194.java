...
public class class194 extends DualNode {
	...
	static boolean method3975(WorldEntity var0, WorldView var1) {
		...
		for (var3 = 0; var3 < var1.field1355.method9005(); ++var3) {
			NPC var7 = (NPC)var1.npcs.get((long)var1.field1355.method9007(var3));
		...
		for (var3 = 0; var3 < var1.field1357.method9005(); ++var3) {
			WorldEntity var8 = (WorldEntity)var1.worldEntities.get((long)var1.field1357.method9007(var3));
