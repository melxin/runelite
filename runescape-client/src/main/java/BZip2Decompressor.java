...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) {
			...
			BZip2Decompressor_state.field5489 = 0;
	...
	static void method10557(BZip2State var0) {
		...
		int var13 = var0.field5489;
		var0.field5489 += var10 - var10;
		if (var0.field5489 < var13) {
		}
		...
		while (true) {
			while (var26) {
				...
				while (true) {
					...
					var0.field5496 = BZip2State.BZip2Decompressor_block[var0.originalPointer] >> 8;
					var0.nblocks_used = 0;
					var0.field5496 = BZip2State.BZip2Decompressor_block[var0.field5496];
					var0.su_ch2 = (byte)(var0.field5496 & 255);
					var0.field5496 >>= 8;
					++var0.nblocks_used;
					var0.field5493 = var47;
					method10557(var0);
					if (var0.field5493 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
						var26 = true;
						break;
					}
