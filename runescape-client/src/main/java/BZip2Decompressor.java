...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) {
			...
			BZip2Decompressor_state.field5713 = 0;
	...
	static void method11122(BZip2State var0) {
		...
		int var13 = var0.field5713;
		var0.field5713 += var10 - var10;
		if (var0.field5713 < var13) {
		}
		...
		var0.su_ch2 = var5;
		class141.BZip2Decompressor_block = var6;
		var0.field5725 = var7;
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		if (class141.BZip2Decompressor_block == null) {
			class141.BZip2Decompressor_block = new int[var0.blockSize100k * 100000];
		}
				...
				while (true) {
					...
					while (var46 != var42) {
						if (var46 != 0 && var46 != 1) {
							...
							class141.BZip2Decompressor_block[var47] = var0.seqToUnseq[var1 & 255] & 255;
							++var47;
							if (var45 == 0) {
								++var43;
								var45 = 50;
							...
							for (var10000[var1 & 255] += var48; var48 > 0; --var48) {
								class141.BZip2Decompressor_block[var47] = var1 & 255;
								++var47;
							}
						}
					}
					...
					for (var36 = 0; var36 < var47; ++var36) {
						var1 = (byte)(class141.BZip2Decompressor_block[var36] & 255);
						var10000 = class141.BZip2Decompressor_block;
						int var10001 = var0.cftab[var1 & 255];
						var10000[var10001] |= var36 << 8;
						var10002 = var0.cftab[var1 & 255]++;
					}

					var0.field5725 = class141.BZip2Decompressor_block[var0.originalPointer] >> 8;
					var0.nblocks_used = 0;
					var0.field5725 = class141.BZip2Decompressor_block[var0.field5725];
					var0.su_ch2 = (byte)(var0.field5725 & 255);
					var0.field5725 >>= 8;
					++var0.nblocks_used;
					var0.field5724 = var47;
					method11122(var0);
					if (var0.field5724 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
						var26 = true;
						break;
					}
