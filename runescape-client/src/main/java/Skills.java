...
public class Skills {
	...
	static void method8174(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, Player var13) {
		ObjectComposition var14 = ModeWhere.getObjectDefinition(var6);
		int var15;
		int var16;
		if (var4 != 1 && var4 != 3) {
			var15 = var14.sizeX;
		...
		int[][] var21 = HttpHeaders.worldView.tileHeights[var0];
		...
		if (var25 != null) {
			WorldView.method2702(HttpHeaders.worldView, var0, var1, var2, var5, -1, 0, 0, 31, (String[])null, var7 + 1, var8 + 1);
