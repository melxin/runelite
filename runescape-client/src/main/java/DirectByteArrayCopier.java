...
public class DirectByteArrayCopier extends AbstractByteArrayCopier {
	...
	static final void method8141(WorldView var0, PacketBuffer var1) {
		for (int var2 = 0; var2 < Client.npcCount; ++var2) {
			...
			if ((var5 & 32) != 0) {
				var4.targetIndex = var1.readSignedShort();
				var4.targetIndex += var1.readUnsignedShortAdd() << 16;
				var6 = 16777215;
			...
			if ((var5 & 1024) != 0) {
				...
				if ((var6 & 1) == 1) {
					...
					if ((var6 & 4) == 4) {
						var9 = 0;
						if (var4.definition.field2130 != null) {
							var9 = var4.definition.field2130.length;
						}
					...
					if ((var6 & 8) == 8) {
						...
						if (var4.definition.recolorTo != null) {
							var10 = var4.definition.recolorTo.length;
						}

						var15 = new short[var10];

						for (var11 = 0; var11 < var10; ++var11) {
							var15[var11] = (short)var1.readSignedShort();
						}
					}

					var21 = false;
					if ((var6 & 16) != 0) {
						var21 = var1.readUnsignedShortLE() == 1;
					}
			...
			if ((var5 & 8192) != 0) {
				...
				var4.spotAnimation = var1.readSignedShort() + Client.cycle;
				var4.field1094 = var1.readUnsignedShortAddLE() + Client.cycle;
				var4.field1095 = var1.readUnsignedShortAddLE();
				var4.pathLength = 0;
				var4.field1040 = 0;
			...
			if ((var5 & 256) != 0) {
				var4.method2717(var1.readUnsignedShortAdd());
			}
			...
			if ((var5 & 16384) != 0) {
				...
				if ((var6 & 1) == 1) {
					...
					if ((var6 & 4) == 4) {
						...
						for (var10 = 0; var10 < var9; ++var10) {
							var14[var10] = (short)var1.readShortLE();
						}
					}
					...
					var21 = false;
					if ((var6 & 16) != 0) {
						var21 = var1.readUnsignedShortAdd() == 1;
					}
			...
			if ((var5 & 4096) != 0) {
				var4.npcCycle = Client.cycle + var1.readUnsignedShortAddLE();
				var4.field1052 = Client.cycle + var1.readSignedShort();
			...
			if ((var5 & 65536) != 0) {
				...
				var4.walkSequence = (var6 & 4) != 0 ? var1.readSignedShort() : var4.definition.walkSequence;
				...
				var4.walkRightSequence = (var6 & 32) != 0 ? var1.readShortLE() : var4.definition.walkRightSequence;
				var4.runSequence = (var6 & 64) != 0 ? var1.readShortLE() : var4.definition.field2121;
				var4.field1068 = (var6 & 128) != 0 ? var1.readShortLE() : var4.definition.field2133;
				var4.field1065 = (var6 & 256) != 0 ? var1.readUnsignedShort() : var4.definition.field2155;
				var4.field1090 = (var6 & 512) != 0 ? var1.readSignedShort() : var4.definition.field2124;
				var4.field1071 = (var6 & 1024) != 0 ? var1.readUnsignedShortAddLE() : var4.definition.field2125;
				var4.field1069 = (var6 & 2048) != 0 ? var1.readShortLE() : var4.definition.field2126;
			...
			if ((var5 & 262144) != 0) {
				...
				if (var6 == 0) {
					...
					for (var9 = 0; var9 < 8; ++var9) {
						if ((var6 & 1 << var9) != 0) {
							var7[var9] = var1.readVarInt();
							var14[var9] = (short)var1.readLargeSmart();
						} else {
							var7[var9] = -1;
							var14[var9] = -1;
						}
