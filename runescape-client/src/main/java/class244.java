...
@ObfuscatedName("jr")
public class class244 extends AbstractRasterizer {
	@ObfuscatedSignature(
		descriptor = "(Ljz;)V"
	)
	class244(Clips var1) {
	...
	void drawAlphaBlendedGraphics(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10, int var11, int var12) {
		...
		if (var28 != 0) {
			...
			int[] var31 = super.field2619.Rasterizer3D_rowOffsets;
			int var32 = super.field2619.clipY;
	...
	void vmethod5725(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10) {
		...
		int[] var20 = super.field2619.Rasterizer3D_rowOffsets;
		int var21 = super.field2619.clipY;
	...
	void drawGradientTriangle(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19, int var20, int var21, int var22) {
		...
		int var24;
		if (var23 == null) {
			var24 = super.field2619.Rasterizer3D_textureLoader.getAverageTextureRGB(var22);
			this.drawAlphaBlendedGraphics(var1, var2, var3, var4, var5, var6, var7, var8, var9, AbstractRasterizer.method5025(var24, var10), AbstractRasterizer.method5025(var24, var11), AbstractRasterizer.method5025(var24, var12));
		} else {
			...
			if (var39 != 0) {
				...
				int var42 = super.field2619.zoom;
				var14 = var13 - var14;
				var17 = var16 - var17;
				var20 = var19 - var20;
				var15 -= var13;
				...
				int[] var52 = super.field2619.Rasterizer3D_rowOffsets;
				int var53 = super.field2619.clipY;
				int var54;
				if (var27 <= var28 && var27 <= var29) {
					if (var27 < var53) {
						...
						if (var28 < var29) {
							...
							var54 = var27 - super.field2619.clipMidY;
							var43 += var45 * var54;
							var46 += var48 * var54;
							var49 += var51 * var54;
					...
					if (var28 < var53) {
						...
						if (var29 < var27) {
							...
							var54 = var28 - super.field2619.clipMidY;
							var43 += var45 * var54;
							var46 += var48 * var54;
							var49 += var51 * var54;
					...
					if (var27 < var28) {
						...
						var54 = var29 - super.field2619.clipMidY;
						var43 += var45 * var54;
						var46 += var48 * var54;
						var49 += var51 * var54;
						if (var37 < var38) {
	...
	void textureMapPolygons(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19, int var20, int var21, int var22) {
		...
		if (var23 == null) {
			...
			if (var39 != 0) {
				...
				int[] var52 = super.field2619.Rasterizer3D_rowOffsets;
				int var53 = super.field2619.clipY;
				int var54 = super.field2619.clipMidY;
				int var55;
				if (var27 <= var28 && var27 <= var29) {
					if (var27 < var53) {
						if (var28 > var53) {
		...
		if (var5 < var6) {
			...
			if (super.field2619.rasterGouraudLowRes) {
				...
				if (super.field2619.currentFaceAlpha == 0) {
					...
					var9 = super.field2619.currentFaceAlpha;
					var10 = 256 - super.field2619.currentFaceAlpha;
					if (var4 > 0) {
						do {
				...
				if (super.field2619.currentFaceAlpha == 0) {
					do {
						var9 = (var7 & ~(var7 >> 31)) >> 8;
						var1[var2++] = super.field2611[var9];
						var7 += var8;
						--var4;
					} while(var4 > 0);
				} else {
	...
	void applyColorFilterToPixelsInRange(int[] var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if (var5 < var6) {
			...
			var4 = var6 - var5 >> 2;
			if (super.field2619.currentFaceAlpha != 0) {
				if (super.field2619.currentFaceAlpha == 254) {
					while (true) {
						--var4;
						if (var4 < 0) {
							var4 = var6 - var5 & 3;
					...
					int var7 = super.field2619.currentFaceAlpha;
					int var8 = 256 - super.field2619.currentFaceAlpha;
	...
	void processPixelsToArray(int[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15) {
		...
		if (var6 < var7) {
			...
			var8 += var9 * var6;
			int var18 = var7 - var6;
			int var24 = var6 - super.field2619.clipMidX;
			var10 += (var13 >> 3) * var24;
			var11 += var24 * (var14 >> 3);
			var12 += (var15 >> 3) * var24;
			int var23 = var12 >> 14;
			...
			if (super.field2617) {
				if (super.field2619.currentFaceAlpha == 0) {
					...
					var25 = super.field2619.currentFaceAlpha;
					var26 = 256 - super.field2619.currentFaceAlpha;
					var27 = var16 * var26 >> 8;
					if (var18 > 0) {
						do {
							var4 = var2[(var3 & 16256) + (var3 >>> 25)];
