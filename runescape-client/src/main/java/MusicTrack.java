...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		this.field3712 = new NodeHashTable(16);
					...
					if (var68 == 23) {
						...
						if (var66 == 0) {
							...
							if (var71 > 0) {
								...
								class346 var73 = (class346)this.field3712.get((long)var72);
								if (var73 == null) {
									var73 = new class346(var65);
									this.field3712.put(var73, (long)var72);
								}

								var73.field3748.set(var74);
							}
						} else if (var66 == 1) {
							if (var69) {
