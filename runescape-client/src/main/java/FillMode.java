...
public enum FillMode implements Enum {
	...
	@ObfuscatedName("ae")
	@ObfuscatedSignature(
		descriptor = "(Ldp;IIIIIILkj;I)V",
		garbageValue = "913763300"
	)
	@Export("addObjects")
	static final void addObjects(WorldView var0, int var1, int var2, int var3, int var4, int var5, int var6, CollisionMap var7) {
		if (!Client.isLowDetail || (var0.tileSettings[0][var2][var3] & 2) != 0 || (var0.tileSettings[var1][var2][var3] & 16) == 0) {
			...
			ObjectComposition var8 = class177.getObjectDefinition(var4);
			int var9;
			int var10;
			if (var5 != 1 && var5 != 3) {
				var9 = var8.sizeX;
			...
			if (var8.hasSound()) {
				WorldMapIcon_1.createObjectSound(var1, var2, var3, var8, var5);
			}
				...
				if (var6 != 10 && var6 != 11) {
					...
					if (var6 >= 12) {
						...
						if (var5 == 0) {
							...
							if (var8.clipped) {
								SpriteMask.Tiles_underlays2[var1][var2][var3 + 1] = 50;
								SpriteMask.Tiles_underlays2[var1][var2 + 1][var3 + 1] = 50;
							}
							...
							if (var8.clipped) {
								SpriteMask.Tiles_underlays2[var1][var2 + 1][var3] = 50;
								SpriteMask.Tiles_underlays2[var1][var2 + 1][var3 + 1] = 50;
							}

							if (var8.modelClipped) {
								var10000 = Canvas.field98[var1][var2 + 1];
								var10000[var3] |= 585;
							}
						} else if (var5 == 3) {
							if (var8.clipped) {
						...
						if (var8.interactType != 0 && var7 != null) {
							var7.method5635(var2, var3, var6, var5, var8.boolean1);
						}

						if (var8.int2 != 16) {
							var22.method4920(var1, var2, var3, var8.int2);
						}
					...
					if (var30 != null && var22.method5088(var1, var2, var3, var16, var9, var10, (Renderable)var30, var6 == 11 ? 256 : 0, var19, var21) && var8.clipped) {
						...
						for (int var32 = 0; var32 <= var9; ++var32) {
							for (int var33 = 0; var33 <= var10; ++var33) {
								if (var29 > SpriteMask.Tiles_underlays2[var1][var32 + var2][var3 + var33]) {
									SpriteMask.Tiles_underlays2[var1][var32 + var2][var3 + var33] = (byte)var29;
								}
							}
						}
					}
