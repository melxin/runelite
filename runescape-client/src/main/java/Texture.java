...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field2538 = var1.readUnsignedByte() == 1;
		...
		if (var2 >= 1 && var2 <= 4) {
			...
			if (var2 > 1) {
				this.field2532 = new int[var2 - 1];

				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field2532[var3] = var1.readUnsignedByte();
				}
			}

			if (var2 > 1) {
				this.field2525 = new int[var2 - 1];

				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field2525[var3] = var1.readUnsignedByte();
				}
			}
			...
			for (var3 = 0; var3 < var2; ++var3) {
				this.field2534[var3] = var1.readInt();
			}
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) {
			...
			if (var10 == null) {
				...
				class262.SpriteBuffer_decode(var10);
				var9 = true;
			}
			...
			if (!var9) {
				...
				var7 = BufferedNetSocket.method10250();
			}

			var7.normalize();
			var10 = var7.pixels;
			int[] var11 = var7.palette;
			int var12 = this.field2534[var6];
