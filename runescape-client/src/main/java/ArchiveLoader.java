...
public class ArchiveLoader {
	...
	@ObfuscatedSignature(
		descriptor = "(Lpg;Ljava/lang/String;)V"
	)
	...
	boolean isLoaded() {
		...
		for (int var1 = 0; var1 < this.groupCount; ++var1) {
			if (!this.archive.method8355(var1) || this.archive.method8377(var1)) {
				++this.loadedCount;
			}
		}
	...
	public static int method2140(int var0, int var1) {
		return (var0 << 8) + var1;
	}

	@ObfuscatedName("jy")
	@ObfuscatedSignature(
		descriptor = "(Ldm;Lcd;IIIIII)V",
		garbageValue = "-1349872306"
	)
	@Export("drawActor2d")
	static final void drawActor2d(WorldView var0, Actor var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null && var1.isVisible()) {
			...
			int var10 = -2;
			if (var1.overheadText != null && (!var9 || !var1.field1077 && (Client.publicChatMode == 4 || !var1.field1096 && (Client.publicChatMode == 0 || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player)var1).isFriend())))) {
				class134.method3733(var0, var1, var1.vmethod2797() + var1.method2444());
				if (Client.viewportTempX > -1 && Client.overheadTextCount < Client.field444) {
					Client.overheadTextXOffsets[Client.overheadTextCount] = class70.fontBold12.stringWidth(var1.overheadText) / 2;
					Client.overheadTextAscents[Client.overheadTextCount] = class70.fontBold12.ascent;
					Client.overheadTextXs[Client.overheadTextCount] = Client.viewportTempX;
					Client.overheadTextYs[Client.overheadTextCount] = Client.viewportTempY - var10;
					Client.overheadTextColors[Client.overheadTextCount] = var1.field1042;
					Client.overheadTextEffects[Client.overheadTextCount] = var1.field1081;
					Client.overheadTextCyclesRemaining[Client.overheadTextCount] = var1.overheadTextCyclesRemaining;
					Client.field501[Client.overheadTextCount] = var1.field1070;
				...
				for (HealthBarConfig var11 = (HealthBarConfig)var1.healthBars.last(); var11 != null; var11 = (HealthBarConfig)var1.healthBars.previous()) {
					...
					if (var12 == null) {
						...
						if (var12.cycleOffset > var87) {
							var89 = var13.field2040 == 0 ? 0 : var13.field2040 * (var87 / var13.field2040);
			...
			Player var90;
			if (var9 && Client.cycle == var1.playerCycle && MoveSpeed.method6337((Player)var1)) {
				var90 = (Player)var1;
				if (var9) {
					class134.method3733(var0, var1, var1.vmethod2797() + 15 + var1.method2444());
			...
			if (var9) {
				...
				if (var90.headIconPk != -1 || var90.headIconPrayer != -1) {
					...
					if (Client.viewportTempX > -1) {
						if (var90.headIconPk != -1) {
							var10 += 25;
							PcmPlayer.headIconPkSprites[var90.headIconPk].drawTransBgAt(var3 + Client.viewportTempX - 12, var4 + Client.viewportTempY - var10);
						}

						if (var90.headIconPrayer != -1) {
							var10 += 25;
							Varcs.headIconPrayerSprites[var90.headIconPrayer].drawTransBgAt(var3 + Client.viewportTempX - 12, var4 + Client.viewportTempY - var10);
						}
					}
				}
				...
				if (var2 >= 0 && Client.field576.method8230() == 3 && Client.field576.method8231() == var8[var2]) {
					...
					if (Client.viewportTempX > -1) {
						...
						ArchiveDisk.headIconHintSprites[1].drawTransBgAt(var3 + Client.viewportTempX - 12, var4 + Client.viewportTempY - var10);
					}
				}
			} else {
				NPC var92 = (NPC)var1;
				int[] var93 = var92.method2787();
				short[] var94 = var92.method2781();
				if (var94 != null && var93 != null) {
					for (int var14 = 0; var14 < var94.length; ++var14) {
						if (var94[var14] >= 0 && var93[var14] >= 0) {
							...
							SpritePixels var17 = (SpritePixels)Client.field473.method9911(var15);
							if (var17 == null) {
								SpritePixels[] var18 = HttpJsonRequestBody.method10636(BoundaryObject.archive8, var93[var14], 0);
								if (var18 != null && var94[var14] < var18.length) {
									var17 = var18[var94[var14]];
									Client.field473.method9921(var15, var17);
								}
							}
			...
			for (int var77 = 0; var77 < 4; ++var77) {
				...
				if (var79 >= 0) {
					...
					var97 = class324.method7034(var1.hitSplatTypes[var77]);
					var81 = var97.field2278;
				...
				if (var16 >= 0) {
					var95 = class324.method7034(var16);
				...
				if (var78 - var81 <= Client.cycle) {
					if (var97 == null) {
						...
						class134.method3733(var0, var1, var1.vmethod2797() / 2 + var1.method2444());
						if (Client.viewportTempX > -1) {
							boolean var98 = true;
							if (var77 == 1) {
							...
							int var64 = var97.field2283 - var63 * var97.field2283 / var97.field2278;
							int var65 = var63 * var97.field2284 / var97.field2278 + -var97.field2284;
							int var66 = var64 + (var3 + Client.viewportTempX - (var52 >> 1));
							int var67 = var65 + (var4 + Client.viewportTempY - 12);
							int var68 = var67;
							int var69 = var43 + var67;
							int var70 = var67 + var97.field2281 + 15;
							...
							int var75;
							if (var95 != null) {
								var73 = var67 + var95.field2281 + 15;
							...
							var74 = 255;
							if (var97.field2285 >= 0) {
								var74 = (var63 << 8) / (var97.field2278 - var97.field2285);
							}
