...
public abstract class class521 extends class522 {
	...
	@ObfuscatedName("ay")
	@ObfuscatedSignature(
		descriptor = "(ILjava/lang/String;Lph;II)Lmb;",
		garbageValue = "2107590413"
	)
	public static PacketBufferNode method9694(int var0, String var1, Language var2, int var3) {
		PacketBufferNode var4 = ScriptEvent.getPacketBufferNode(ClientPacket.MESSAGE_PUBLIC, Client.packetWriter.isaacCipher);
		...
		class344.method6942(var4.packetBuffer, var1);
		if (var0 == class369.field4061.rsOrdinal()) {
