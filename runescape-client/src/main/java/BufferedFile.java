...
public class BufferedFile {
	...
	@ObfuscatedName("aj")
	@ObfuscatedGetter(
		longValue = -8417615739158634513L
	)
	...
	@ObfuscatedName("ae")
	@ObfuscatedGetter(
		longValue = -4672327137630642697L
	)
	...
	@ObfuscatedName("ac")
	@ObfuscatedGetter(
		longValue = -5054414113371059669L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("aa")
	@ObfuscatedGetter(
		longValue = -7618019878220388619L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("ap")
	@ObfuscatedGetter(
		longValue = -126932683177959589L
	)
	@Export("length")
	long length;
	@ObfuscatedName("ad")
	@ObfuscatedGetter(
		longValue = 6045503047883608515L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	public final File method11088() {
		return this.accessFile.method11054();
	}

	@ObfuscatedName("ah")
	@ObfuscatedSignature(
		descriptor = "([BI)V",
		garbageValue = "-902100307"
	)
	@Export("readFully")
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) {
			...
			this.fileOffset += -1171719193L * (long)(this.writeBufferLength * -1063131177);
			if (this.fileOffset > this.fileLength) {
				this.fileLength = this.fileOffset;
			}
