...
public class BufferedFile {
	...
	@ObfuscatedName("ak")
	@ObfuscatedGetter(
		longValue = -1047395612733414115L
	)
	...
	@ObfuscatedName("ap")
	@ObfuscatedGetter(
		longValue = 5345664010121337071L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("ay")
	@ObfuscatedGetter(
		longValue = -8916147190238263293L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("au")
	@ObfuscatedGetter(
		longValue = -8179259620974557791L
	)
	@Export("length")
	long length;
	@ObfuscatedName("az")
	@ObfuscatedGetter(
		longValue = -2635910061598715747L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-1080459254"
	)
	public final File method11350() {
		return this.accessFile.method11345();
	}

	@ObfuscatedName("ae")
	@ObfuscatedSignature(
		descriptor = "([BI)V",
		garbageValue = "12149450"
	)
	@Export("readFully")
	...
	void flush() throws IOException {
		if (-1L != this.writeBufferOffset) {
			...
			this.fileOffset += 1023942981L * (long)(this.writeBufferLength * -218805875);
			if (this.fileOffset > this.fileLength) {
				this.fileLength = this.fileOffset;
			}
