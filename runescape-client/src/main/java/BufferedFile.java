...
public class BufferedFile {
	...
	@ObfuscatedName("ad")
	@ObfuscatedGetter(
		longValue = 4423229045103765615L
	)
	...
	@ObfuscatedName("ao")
	@ObfuscatedGetter(
		longValue = 6186318618299910139L
	)
	...
	@ObfuscatedName("aa")
	@ObfuscatedGetter(
		longValue = -7995001995864302439L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("as")
	@ObfuscatedGetter(
		longValue = 309135556713061621L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("ae")
	@ObfuscatedGetter(
		longValue = -7308957925403079007L
	)
	@Export("length")
	long length;
	@ObfuscatedName("ax")
	@ObfuscatedGetter(
		longValue = 9011334670875384329L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) {
			...
			this.fileOffset += 1451627527L * (long)(this.writeBufferLength * 561322423);
			if (this.fileOffset > this.fileLength) {
				this.fileLength = this.fileOffset;
			}
