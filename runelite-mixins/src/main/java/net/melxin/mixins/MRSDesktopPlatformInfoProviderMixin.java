...
public abstract class MRSDesktopPlatformInfoProviderMixin implements RSDesktopPlatformInfoProvider
{
	...
	public RSPlatformInfo copy$get()
	{
		...
		RSPlatformInfo rsModifiedPlatformInfo = newPlatformInfo(os, arch64, osVersion, vendor, javaMajor, javaMinor, javaPatch, false, maxMemory, cpuCores, 0, clockSpeed, "", "", "", "", 0, 0, 0, 0, "", "", new int[3], 0, "", "");
		client.getLogger().info("Using modified platform info: os:{}, arch64:{}, osVersion:{}, vendor:{}, javaMajor:{}, javaMinor:{}, javaPatch:{}, maxMemory:{}, cpuCores:{}, clockSpeed:{}", rsModifiedPlatformInfo.getOs(), rsModifiedPlatformInfo.isArch64(), rsModifiedPlatformInfo.getOsVersion(), rsModifiedPlatformInfo.getVendor(), rsModifiedPlatformInfo.getJavaMajor(), rsModifiedPlatformInfo.getJavaMinor(), rsModifiedPlatformInfo.getJavaPatch(), rsModifiedPlatformInfo.getMaxMemory(), rsModifiedPlatformInfo.getCpuCores(), rsModifiedPlatformInfo.getClockSpeed());
		return rsModifiedPlatformInfo;
	}
}